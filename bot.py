...
async def help_message(event):
    helptext = "**Help Menu of MentionAllBot**\n\nCommand: /mentionall\n__You can use this command with text what you " \
               "want to mention others.__\n`Example: /mentionall Good Morning!`\n__You can you this command as a " \
               "reply to any message. Bot will tag users to that replied messsage__.\n\nFollow [@AnjanaMadu](" \
               "https://github.com/AnjanaMadu) on Github "
    await event.reply(
        helptext,
        link_preview=False,
        buttons=button
